...
const { cumMouseMove, cumMouseLeave, mousePositione } = useMouseMotion()
        ...
        <form  class="space-y-6 bg-white p-8 rounded-lg shadow-lg aspect-square">
          ...
          <div class="space-y-2">
            ...
            <div class="flex flex-col space-y-2">
              <Label class="block">Fecha de la misión</Label>

...
import FaqSection from "@/pages/05_faqs/FaqSection.vue"
import PartnersMarquee from "@/pages/06_partners/PartnersMarquee.vue"
</script>
...
<template>
  <div>
    ...
    <section id="programa" class="scroll-mt-20">
      <CalendarSection />
    </section>

    <section id="artistas" class="scroll-mt-20">
      <ArtistsSection />
    </section>
